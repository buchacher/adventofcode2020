    ...
    public static ArrayList<Integer> findSummation(ArrayList<Integer> inpt) {
        ...
        for (int i = 0; i < inpt.size(); i++) {
            for (int j = 0; j < inpt.size(); j++) {
                for (int h = 0; h < inpt.size(); h++) {
                    if (inpt.get(i) + inpt.get(j) + inpt.get(h) == 2020) {
                        if (!(entries.contains(inpt.get(i)) && entries.contains(inpt.get(j)) && entries.contains(inpt.get(h)))) {
                            entries.add(inpt.get(i));
                            entries.add(inpt.get(j));
                            entries.add(inpt.get(h));
                        }
                    }
                }
            }
